...
public class showAllOCAdapter extends RecyclerView.Adapter<showAllOCAdapter.ViewHolder>{

    ArrayList<OCHelperClass> EventsList;

    public showAllOCAdapter(ArrayList<OCHelperClass> eventsList) {
